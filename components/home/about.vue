<template>
<section id="about" class="relative py-50" >
<div class="p-5 flex flex-wrap justify-around gap-3 py-10">
    ...
    <div class="">
        <img src="/img/about1.png" alt="" class="md:w-72 w-full" data-aos="fade-up">
    </div>
</div>
     ...
     <div class="relative flex justify-center items-center">
            <div class="md:container mx-auto max-w-7xl flex md:justify-center md:items-center flex-wrap gap-3">
                <div class="md:max-w-1/2 w-full">
                    <div class="font-poppins text-4xl font-bold"><span class="text-green-600">About</span> Us</div>
                    <div class="font-poppins">
                       z
                    </div>
                </div>
                <div class="md:max-w-1/2 w-full">
                    <img src="/img/about1.png" alt="" class="w-80">
                </div>
            </div>
           
        </div>
         <div class="absolute -z-20 top-0 left-0">
                                    <img src="/img/palmLT.png" alt="" class="w-48 md:w-72 opacity-40">
                                </div>
   </section>z -->
</template>
